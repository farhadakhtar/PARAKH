"""
PARAKH Stage 1 — from pathlib import Path
...
# Must match VENDOR_SURNAMES length = 20; weights sum to ~1.0
VENDOR_WEIGHTS = [
    0.25, 0.20, 0.15, 0.10, 0.08, 0.05, 0.05, 0.04,
    0.04, 0.03, 0.03, 0.02, 0.02, 0.02, 0.02, 0.01, 0.01,
    0.01, 0.01, 0.01,
]
